...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for practice and weekend matches",
        "schedule": "Tuesdays, Thursdays, Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, learn new strokes, and prepare for swim meets",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["lisa@mergington.edu", "noah@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and mixed media in a creative studio space",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["chloe@mergington.edu", "jack@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, staging, and performance for school productions",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build public speaking and argumentation skills through debate competitions",
